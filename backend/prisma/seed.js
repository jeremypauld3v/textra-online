...
async function main() {
        ...
        for (const td of c.tiers) {
            for (const slot of c.slots) {
                ...
                if (Math.random() < uniqueChance) {
                    ...
                    itemData[picked] = value;
                }
                if (isWeapon)
                    itemData.classType = c.cls;
    ...
    const monsterDefs = [
        // Each monster drops materials + gear from its tier (high chance) down to T1 (low chance)
        { name: "Forest Slime", hp: 60, atk: 8, def: 3, exp: 20, gold: 5, minDepth: 0, loot: [
                { item: "T1_FIBER", chance: 0.7, min: 1, max: 3 },
                { item: "WARRIOR_T1_WEAPON", chance: 0.06, min: 1, max: 1 },
                { item: "ARCHER_T1_WEAPON", chance: 0.06, min: 1, max: 1 },
                { item: "MAGE_T1_WEAPON", chance: 0.06, min: 1, max: 1 },
                { item: "WARRIOR_T1_BOOTS", chance: 0.05, min: 1, max: 1 },
                { item: "ARCHER_T1_GLOVES", chance: 0.05, min: 1, max: 1 },
                { item: "MAGE_T1_HELMET", chance: 0.05, min: 1, max: 1 },
                { item: "WARRIOR_T1_GLOVES", chance: 0.04, min: 1, max: 1 },
                { item: "ARCHER_T1_HELMET", chance: 0.04, min: 1, max: 1 },
                { item: "MAGE_T1_BOOTS", chance: 0.04, min: 1, max: 1 },
            ] },
        { name: "Dire Wolf", hp: 200, atk: 30, def: 15, exp: 100, gold: 25, minDepth: 150, loot: [
                { item: "T2_HIDE", chance: 0.6, min: 1, max: 2 },
                { item: "WARRIOR_T1_CHEST", chance: 0.10, min: 1, max: 1 },
                { item: "ARCHER_T1_CHEST", chance: 0.10, min: 1, max: 1 },
                { item: "MAGE_T1_BOOTS", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T1_GLOVES", chance: 0.08, min: 1, max: 1 },
                { item: "ARCHER_T1_BOOTS", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T1_HELMET", chance: 0.06, min: 1, max: 1 },
                { item: "MAGE_T1_GLOVES", chance: 0.06, min: 1, max: 1 },
                { item: "MAGE_T1_HELMET", chance: 0.06, min: 1, max: 1 },
            ] },
        { name: "Skeleton Warrior", hp: 350, atk: 55, def: 30, exp: 200, gold: 50, minDepth: 350, loot: [
                { item: "IRON_ORE", chance: 0.5, min: 2, max: 5 },
                { item: "WARRIOR_T2_WEAPON", chance: 0.08, min: 1, max: 1 },
                { item: "ARCHER_T2_WEAPON", chance: 0.08, min: 1, max: 1 },
                { item: "MAGE_T2_HELMET", chance: 0.07, min: 1, max: 1 },
                { item: "WARRIOR_T2_BOOTS", chance: 0.06, min: 1, max: 1 },
                { item: "WARRIOR_T2_GLOVES", chance: 0.06, min: 1, max: 1 },
                { item: "WARRIOR_T1_GLOVES", chance: 0.10, min: 1, max: 1 },
                { item: "ARCHER_T1_HELMET", chance: 0.10, min: 1, max: 1 },
            ] },
        { name: "Crypt Spider", hp: 280, atk: 65, def: 20, exp: 180, gold: 45, minDepth: 500, loot: [
                { item: "T2_FIBER", chance: 0.6, min: 1, max: 3 },
                { item: "ARCHER_T2_BOOTS", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T2_GLOVES", chance: 0.08, min: 1, max: 1 },
                { item: "MAGE_T2_CHEST", chance: 0.06, min: 1, max: 1 },
                { item: "WARRIOR_T2_HELMET", chance: 0.06, min: 1, max: 1 },
                { item: "ARCHER_T1_BOOTS", chance: 0.12, min: 1, max: 1 },
                { item: "MAGE_T1_CHEST", chance: 0.10, min: 1, max: 1 },
            ] },
        { name: "Minotaur", hp: 800, atk: 120, def: 80, exp: 500, gold: 120, minDepth: 750, loot: [
                { item: "T3_HIDE", chance: 0.5, min: 1, max: 2 },
                { item: "WARRIOR_T3_CHEST", chance: 0.10, min: 1, max: 1 },
                { item: "ARCHER_T3_HELMET", chance: 0.10, min: 1, max: 1 },
                { item: "MAGE_T3_WEAPON", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T3_BOOTS", chance: 0.07, min: 1, max: 1 },
                { item: "ARCHER_T2_CHEST", chance: 0.12, min: 1, max: 1 },
                { item: "MAGE_T2_BOOTS", chance: 0.10, min: 1, max: 1 },
                { item: "WARRIOR_T1_HELMET", chance: 0.15, min: 1, max: 1 },
            ] },
        { name: "Sea Serpent", hp: 600, atk: 100, def: 60, exp: 450, gold: 100, minDepth: 1000, loot: [
                { item: "T3_FISH", chance: 0.6, min: 1, max: 3 },
                { item: "MAGE_T3_BOOTS", chance: 0.10, min: 1, max: 1 },
                { item: "ARCHER_T3_GLOVES", chance: 0.10, min: 1, max: 1 },
                { item: "WARRIOR_T3_WEAPON", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T3_HELMET", chance: 0.07, min: 1, max: 1 },
                { item: "ARCHER_T2_GLOVES", chance: 0.12, min: 1, max: 1 },
                { item: "MAGE_T2_WEAPON", chance: 0.10, min: 1, max: 1 },
            ] },
        { name: "Golem", hp: 1200, atk: 180, def: 160, exp: 900, gold: 200, minDepth: 1250, loot: [
                { item: "COPPER_ORE", chance: 0.5, min: 2, max: 4 },
                { item: "WARRIOR_T3_HELMET", chance: 0.10, min: 1, max: 1 },
                { item: "ARCHER_T3_CHEST", chance: 0.10, min: 1, max: 1 },
                { item: "MAGE_T3_GLOVES", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T2_CHEST", chance: 0.12, min: 1, max: 1 },
                { item: "MAGE_T2_HELMET", chance: 0.10, min: 1, max: 1 },
            ] },
        { name: "Dark Mage", hp: 900, atk: 200, def: 80, exp: 800, gold: 180, minDepth: 1500, loot: [
                { item: "T3_FIBER", chance: 0.5, min: 1, max: 2 },
                { item: "POTION_M", chance: 0.3, min: 1, max: 1 },
                { item: "MAGE_T3_CHEST", chance: 0.10, min: 1, max: 1 },
                { item: "ARCHER_T3_WEAPON", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T3_GLOVES", chance: 0.07, min: 1, max: 1 },
                { item: "MAGE_T3_BOOTS", chance: 0.07, min: 1, max: 1 },
                { item: "WARRIOR_T2_BOOTS", chance: 0.12, min: 1, max: 1 },
            ] },
        { name: "Wyvern", hp: 2500, atk: 350, def: 280, exp: 2000, gold: 450, minDepth: 1800, loot: [
                { item: "T4_HIDE", chance: 0.4, min: 1, max: 2 },
                { item: "ARCHER_T4_BOOTS", chance: 0.10, min: 1, max: 1 },
                { item: "WARRIOR_T4_WEAPON", chance: 0.08, min: 1, max: 1 },
                { item: "MAGE_T4_HELMET", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T4_GLOVES", chance: 0.07, min: 1, max: 1 },
                { item: "ARCHER_T3_CHEST", chance: 0.12, min: 1, max: 1 },
                { item: "MAGE_T3_WEAPON", chance: 0.10, min: 1, max: 1 },
                { item: "WARRIOR_T2_HELMET", chance: 0.15, min: 1, max: 1 },
            ] },
        { name: "Vampire Lord", hp: 3500, atk: 500, def: 350, exp: 3000, gold: 700, minDepth: 2200, loot: [
                { item: "T4_FIBER", chance: 0.4, min: 1, max: 2 },
                { item: "POTION_L", chance: 0.2, min: 1, max: 1 },
                { item: "WARRIOR_T4_CHEST", chance: 0.10, min: 1, max: 1 },
                { item: "ARCHER_T4_HELMET", chance: 0.10, min: 1, max: 1 },
                { item: "MAGE_T4_GLOVES", chance: 0.08, min: 1, max: 1 },
                { item: "WARRIOR_T4_BOOTS", chance: 0.07, min: 1, max: 1 },
                { item: "ARCHER_T3_BOOTS", chance: 0.12, min: 1, max: 1 },
                { item: "MAGE_T2_CHEST", chance: 0.15, min: 1, max: 1 },
            ] },
